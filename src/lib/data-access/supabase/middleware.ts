 ...
 * behind a signed-in user. Role-level checks (Owner/Editor/Viewer) happen
 * further down in the admin layout, once we have the user's profile —
 * middleware only needs to know "signed in or not."
 */
